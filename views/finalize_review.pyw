...
# Form implementation generated from reading ui file 'finalize_review.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 951, 521))
        ...
        self.finalize_label.setStyleSheet("background-color: #FFC426;\n"
...
"border-color: #FFC426;")
        ...
        self.finalize_attachment_label = QtWidgets.QLabel(self.main_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.finalize_attachment_label.sizePolicy().hasHeightForWidth())
        self.finalize_attachment_label.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Nunito")
        font.setPointSize(18)
        self.finalize_attachment_label.setFont(font)
        self.finalize_attachment_label.setObjectName("finalize_attachment_label")
        self.gridLayout.addWidget(self.finalize_attachment_label, 4, 0, 1, 1)
        self.finalize_contacts_label = QtWidgets.QLabel(self.main_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.finalize_contacts_label.sizePolicy().hasHeightForWidth())
        self.finalize_contacts_label.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Nunito")
        font.setPointSize(18)
        self.finalize_contacts_label.setFont(font)
        self.finalize_contacts_label.setObjectName("finalize_contacts_label")
        self.gridLayout.addWidget(self.finalize_contacts_label, 2, 0, 1, 1)
        self.finalize_login_label = QtWidgets.QLabel(self.main_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.finalize_login_label.sizePolicy().hasHeightForWidth())
        self.finalize_login_label.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Nunito")
        font.setPointSize(18)
        self.finalize_login_label.setFont(font)
        self.finalize_login_label.setObjectName("finalize_login_label")
        self.gridLayout.addWidget(self.finalize_login_label, 0, 0, 1, 1)
        self.finalize_message_label = QtWidgets.QLabel(self.main_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.finalize_message_label.sizePolicy().hasHeightForWidth())
        self.finalize_message_label.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Nunito")
        font.setPointSize(12)
        self.finalize_message_label.setFont(font)
        self.finalize_message_label.setObjectName("finalize_message_label")
        self.gridLayout.addWidget(self.finalize_message_label, 3, 0, 1, 1)
        self.start_sending_messages = QtWidgets.QPushButton(self.main_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.start_sending_messages.sizePolicy().hasHeightForWidth())
        self.start_sending_messages.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Nunito")
        font.setPointSize(32)
        self.start_sending_messages.setFont(font)
        self.start_sending_messages.setStyleSheet("background-color:\"#076FD9\";\n"
"color:\"#FFFFFF\";")
        self.start_sending_messages.setObjectName("start_sending_messages")
        self.gridLayout.addWidget(self.start_sending_messages, 5, 0, 1, 1)
...
"color:\"#FFFFFF\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.finalize_attachment_label.setText(_translate("MainWindow", "You haven\'t added a attachment"))
        self.finalize_contacts_label.setText(_translate("MainWindow", "You have not imported a contacts file"))
        self.finalize_login_label.setText(_translate("MainWindow", "You are not logged in"))
        self.finalize_message_label.setText(_translate("MainWindow", "You haven\'t added a message"))
        self.start_sending_messages.setText(_translate("MainWindow", "     Send     "))
